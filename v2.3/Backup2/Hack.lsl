...
float SPEED_WAT = 0.7;
float SPEED_LINDEN_REALMS = 0.3;//0.044444444;//0.3;
float SPEED_LINDEN_REALMS2 = 0.7;//0.7;
float SPEED_LINDEN_REALMS3 = 1.1;//1.1;
float SPEED_LINDEN_REALMS5 = 3.1;//3.1;
float SPEED_LINDEN_REALMS5X = 3.0;//3.0;
float SPEED_LINDEN_REALMS4 = 0.05;//0.05;
float SPEED_LINDEN_REALMS45 = 0.05;//0.05;
float MAXDISTANCE = 2;
...
AirGO()
{
    ...
    else
    {
        ...
        if(RCDI==0)
        {
            ...
            else if(~llListFindList(LR8,(list)region)) // Region de el lago
            {
                if(CA==8)
                {
                    ZK=1;
            ...
            else if(~llListFindList(LR2,(list)region))
            {
                ...
                else if(ZK!=1)
                {
                    ...
                    else if(CA!=1)
                    {
                        ...
                        {
                            PROFinder(POSRegion3,SPEED_WAT,MAXDISTANCE2);
