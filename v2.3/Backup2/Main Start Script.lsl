...
string Strings1()
{
  ...
  //  "\nOFFSET MATCHED IN: "+(string)ENVIADOR_OFFSET
    );
}
string Strings2()
{
...
default
{
    timer()
    {
       ...
       // }
        ...
        //llSetText("HUD STimer: "+(string)((integer)llGetTime())+" seg."+
        //"\n \n "+STRING_SERVER
        //,color,1.0);

        //Stuck();
        ///llSend("OFFSE"+(string)ENVIADOR_OFFSET);
    ...
    link_message(integer sender_num, integer num, string str, key id)
    {
        ...
        //else if(llGetSubString(str,0,4)=="KLKWC")
        //{
        //    STRING_SERVER=llDeleteSubString(str,0,4);
        //}
    ...
    listen(integer channel, string name, key id, string message)
    {
        ...
        //}
        //else if(llGetOwnerKey(id)==llGetOwner() & channel==-99543)
        //{
        //    ENVIADOR_OFFSET=(float)message;
        //    llOwnerSay("OFFSET MATCHED IN: "+(string)ENVIADOR_OFFSET);
        //    X4();
        //}
        //else 
        if(llGetOwnerKey(id)==llGetOwner() & channel==1)
        {
            ...
            //else if(message=="FORCEDAUTO>>")
            //{
            //    Listens = llListen(-99543,"",llGetOwner(),"");
            //    llSleep(0.3);
            //    llTextBox(llGetOwner(),"Debe insertar el numbero correspondiente al Up/Down del agarrado de diamantes, rangos de 0.47 a 0.49: (Default 0.472) ",-99543);                
            //}
