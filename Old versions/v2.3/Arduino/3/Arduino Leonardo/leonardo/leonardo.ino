...
unsigned int DondeEmpezarVARIABLE = 24; // Numero de cuenta por empezar, cuentas guardadas en el script del arduino MEGA.
unsigned int CuentaDondeFinalizar = 40; // Numero de cuenta que finalizara.
