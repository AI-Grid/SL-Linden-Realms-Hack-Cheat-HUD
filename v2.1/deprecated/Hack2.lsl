//ESTE SCRIPT ES SOLO PRUEBA NO SE HABILITA
...
float SPEED = 0.05; // SPEED FIRST
float SPEED2 = 0.05; // SPEED SENSOR
float SPEED3 = 0.05; // SLEEP SENSOR
float SPEED4 = 0.05; // SLEEP FIRST
