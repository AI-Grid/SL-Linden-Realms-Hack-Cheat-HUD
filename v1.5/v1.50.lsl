...
float TIME_DELAY_SECONDS = 15.0;//15.0; //DEFAULT
...
list POSRegion12 = 
[
<154.92320, 42.91892, 30.39220>,
<154.92320, 42.91892, 30.39220>,
<144.48240, 57.23797, 45.91842>,
<145.02280, 92.31374, 50.94342>,
<167.62850, 128.55930, 50.29763>,
<191.65070, 188.90130, 48.91420>
//<235.94100, 180.11120, 58.34655>,
//<224.94830, 150.70750, 64.58587>,
//<202.28360, 119.27590, 62.50500>,
//<137.12090, 90.44455, 66.15599>,
//<70.79817, 128.73730, 70.13555>,
//<77.45488, 209.27890, 58.87533>,
//<113.49590, 231.93520, 65.12796>,
//<135.59230, 235.89130, 67.00790>,
//<164.30760, 235.85370, 75.70943>,
//<192.38670, 227.97210, 76.25227>,
//<214.73020, 202.06090, 81.10702>,
//<156.78100, 172.13020, 79.66746>,
...
AirGO()
{
    ...
    {
        HOLA=0;
        llOwnerSay(xD+" Algo te detecto, volveras a la misma posición automaticamente en unos seugndos. Si 'el avatar queda en el aire' presionar la tecla Avanzar(W). Si el blob te detecta de la misma forma que antes, quita y añade de vuelta el HUD y moverse.");
    }
    ...
    {
        PROFinder(POSRegion12,SPEED_LINDEN_REALMS3,2.0);
